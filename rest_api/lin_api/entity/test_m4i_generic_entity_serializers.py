...
# from rest_api import get_atlas_connection
# from rest_api.app import flask_app
# from tests.test_settings import atlas_sets
#
#
# def config():
#     store = ConfigStore.get_instance()
#     store.set_config("atlas.server.url", atlas_sets['server'])
#     store.set_config("atlas.server.port", atlas_sets['port'])
#     store.set_config("atlas.server.username", atlas_sets['username'])
#     store.set_config("atlas.server.password", atlas_sets['password'])
#
#
# # END config
#
